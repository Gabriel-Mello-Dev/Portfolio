...
const Home = () => {
  return (
    <div className="min-h-screen w-full bg-black text-white">
      ...
      <section
        id="projects"
        className=" mx-auto py-24 px-6"
        style={{
          background: "linear-gradient(to bottom, #030719, #000001)",
        }}
      >
      ...
      >
        ...
        <p className="text-gray-300 mt-6 leading-relaxed">
          Criação de cenas, GLTF, textura, environment, iluminação, instancing,
          shadows, OrbitControls custom e integração completa com React Three
          Fiber.
        </p>
        <Scene3D />
      </section>
